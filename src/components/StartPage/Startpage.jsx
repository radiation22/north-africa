...
import pic1 from "../../assets/Mural-reliefs-hall-Small-Temple-Aswan-Egypt.webp";
      ...
      <div className="flex bg-[#2F0B0C] flex-col-reverse md:flex lg:flex-row items-center py-5 px-2 w-full">
        ...
        <div className="w-[100%] p-2 lg:p-8 lg:w-[50%]">
          ...
          <h1 className="text-white text-xl mt-4 font-bold">
            North Africa (sometimes Northern Africa) is a region encompassing
            the northern portion of the African continent
          </h1>
